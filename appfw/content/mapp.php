...
class fw_app extends App\app{
  ...
  public $APP_JS="mapp.js";
  public $APP_CSS="mapp.css";
  public $APP_FILES=array("tool/app_view.php",
                          "admin/app_a.php"
                          );
  ...
  function __construct($appdir=""){
    ...
    if ($fwcfg->FW_ADMIN_MODE){
      $this->APP_MENU=array(
                        array("Menü1",$fwcfg->FW_ADMIN_LINK."=a&".$this->APP_MENU_LETTER."=1"),
                        array("Menü2",$fwcfg->FW_ADMIN_LINK."=a&".$this->APP_MENU_LETTER."=2"),
                        array("Menü3",$fwcfg->FW_ADMIN_LINK."=a&".$this->APP_MENU_LETTER."=3"),
