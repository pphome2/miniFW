...
function page_header_view(){
	...
	if (file_exists("$MA_TEMPLATE_DIR/$MA_APP_TEMPLATE/$MA_HEADER_VIEW")){
		include("$MA_TEMPLATE_DIR/$MA_APP_TEMPLATE/$MA_HEADER_VIEW");
	}
	if ($MA_ENABLE_SYSTEM_JS){
    	if (file_exists("$MA_INCLUDE_DIR/$MA_JS_BEGIN")){
	    	include("$MA_INCLUDE_DIR/$MA_JS_BEGIN");
...
function page_footer_view(){
	...
	if (file_exists("$MA_TEMPLATE_DIR/$MA_APP_TEMPLATE/$MA_FOOTER_VIEW")){
		include("$MA_TEMPLATE_DIR/$MA_APP_TEMPLATE/$MA_FOOTER_VIEW");
	}
}
