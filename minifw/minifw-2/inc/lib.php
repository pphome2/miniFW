...
function page_header(){
	global $MA_DEF_HEADER,$MA_JS_BEGIN,$MA_CSS,$MA_STYLEINDEX,$MA_SITENAME,$MA_ROOT_HOME,
			...
			$MA_ENABLE_HEADER,$MA_SEARCH_PAGE,$MA_PRIVACY_PAGE,$MA_FAVICON,$MA_ROOT_NAME,
            $MA_ENABLE_PRIVACY,$MA_ENABLE_PRINT,$MA_ENABLE_SEARCH,$MA_ENABLE_THEME,
            $MA_TITLE,$MA_BACKPAGE,$L_SITEHOME,$MA_ENABLE_SYSTEM_JS,$MA_APP_TEMPLATE,
            $MA_INCLUDE_DIR,$MA_CONTENT_DIR,$MA_TEMPLATE_DIR;

	if (file_exists("$MA_INCLUDE_DIR/$MA_DEF_HEADER")){
		include("$MA_INCLUDE_DIR/$MA_DEF_HEADER");
	}
...
function page_footer(){
	global $MA_JS_END,$MA_DEF_FOOTER,$MA_ADMINFILE,$MA_LOGIN_TIMEOUT,$MA_COOKIE_STYLE,$MA_STYLEINDEX,
            ...
            $MA_ENABLE_PRIVACY,$MA_ENABLE_PRINT,$MA_ENABLE_SEARCH,$MA_ENABLE_THEME,
            $MA_FOOTERMENU,$MA_MENU_FIELD,$MA_ROOT_NAME,$MA_APP_TEMPLATE,
            $MA_INCLUDE_DIR,$MA_CONTENT_DIR,$MA_TEMPLATE_DIR;
	...
	if (file_exists("$MA_INCLUDE_DIR/$MA_DEF_FOOTER")){
		include("$MA_INCLUDE_DIR/$MA_DEF_FOOTER");
	}
}
...
function page_header_view(){
	global $MA_DEF_HEADER_VIEW,$MA_JS_BEGIN,$MA_CSS,$MA_STYLEINDEX,$MA_SITENAME,$MA_ROOT_HOME,
			$MA_ADMINFILE,$L_ROOTHOME,$MA_COOKIE_STYLE,$MA_SITE_HOME,$MA_ENABLE_SYSTEM_CSS,
			$MA_MENU,$MA_MENU_FIELD,$MA_LOGGEDIN,$MA_COOKIE_LOGIN,$L_LOGOUT,$MA_DOCTYPE,
			$MA_SEARCH_ICON_HREF,$MA_SEARCH_ICON_JS,$MA_SEARCHFILE,$MA_LOGOUT_IN_HEADER,
			$L_SITENAME,$MA_ADMIN_USER,$MA_ADMINMENU,$MA_ADMINMENU_FIELD,$MA_APPCSSFILE,
			$MA_ENABLE_HEADER,$MA_PRIVACY_PAGE,$MA_SEARCH_PAGE,$MA_FAVICON,$MA_ROOT_NAME,
            ...
            $MA_INCLUDE_DIR,$MA_CONTENT_DIR,$MA_TEMPLATE_DIR,$MA_APP_TEMPLATE;

	if (file_exists("$MA_INCLUDE_DIR/$MA_DEF_HEADER_VIEW")){
		include("$MA_INCLUDE_DIR/$MA_DEF_HEADER_VIEW");
	}
	if ($MA_ENABLE_SYSTEM_JS){
    	if (file_exists("$MA_INCLUDE_DIR/$MA_JS_BEGIN")){
	    	include("$MA_INCLUDE_DIR/$MA_JS_BEGIN");
...
function page_footer_view(){
	global $MA_JS_END,$MA_DEF_FOOTER_VIEW,$MA_ADMINFILE,$MA_LOGIN_TIMEOUT,$MA_STYLEINDEX,
	...
	if (file_exists("$MA_INCLUDE_DIR/$MA_DEF_FOOTER_VIEW")){
		include("$MA_INCLUDE_DIR/$MA_DEF_FOOTER_VIEW");
	}
}


# page header print
function page_header_print(){
	global $MA_DEF_HEADER_PRINT,$MA_JS_BEGIN,$MA_CSS,$MA_STYLEINDEX,$MA_SITENAME,$MA_ROOT_HOME,
			$MA_ADMINFILE,$L_ROOTHOME,$MA_COOKIE_STYLE,$MA_SITE_HOME,$MA_ENABLE_SYSTEM_CSS,
			$MA_MENU,$MA_MENU_FIELD,$MA_LOGGEDIN,$MA_COOKIE_LOGIN,$L_LOGOUT,$MA_DOCTYPE,
			$MA_SEARCH_ICON_HREF,$MA_SEARCH_ICON_JS,$MA_SEARCHFILE,$MA_LOGOUT_IN_HEADER,
			$L_SITENAME,$MA_ADMIN_USER,$MA_ADMINMENU,$MA_ADMINMENU_FIELD,$MA_APPCSSFILE,
	...
	if (file_exists("$MA_INCLUDE_DIR/$MA_DEF_HEADER_PRINT")){
		include("$MA_INCLUDE_DIR/$MA_DEF_HEADER_PRINT");
	}
	if ($MA_ENABLE_SYSTEM_JS){
    	if (file_exists("$MA_INCLUDE_DIR/$MA_JS_BEGIN")){
	    	include("$MA_INCLUDE_DIR/$MA_JS_BEGIN");
...
# page footer print
function page_footer_print(){
	global $MA_JS_END,$MA_DEF_FOOTER_PRINT,$MA_ADMINFILE,$MA_LOGIN_TIMEOUT,$MA_STYLEINDEX,
			$MA_COPYRIGHT,$MA_CSS,$MA_COOKIE_STYLE,$L_THEME,$MA_PRIVACYFILE,
			$L_PRIVACY_MENU,$MA_LOGGEDIN,$MA_COOKIE_LOGIN,$L_LOGOUT,$L_COOKIE_TEXT,
			$MA_PRIVACY_PAGE,$MA_ENABLE_FOOTER,$MA_STYLEPARAM_NAME,$MA_SEARCH_PAGE,
			$MA_ENABLE_LOGIN_VIEW,$MA_ENABLE_SYSTEM_JS,$MA_ENABLE_FOOTER_VIEW,
	...
	if (file_exists("$MA_INCLUDE_DIR/$MA_DEF_FOOTER_PRINT")){
		include("$MA_INCLUDE_DIR/$MA_DEF_FOOTER_PRINT");
	}
}
