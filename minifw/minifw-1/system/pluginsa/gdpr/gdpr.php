...
function gdpr(){
	global $SYS_PLUGINS_DIR,$SYS_COOKIES_DATA,$SYS_COOKIES_TIME,
			$SYS_COOKIES_NAME,$SYS_COOKIES_STORED_DATA,
			$SYS_PRIVACY_POLICY,$GDPRNUM;
	
	if ($GDPRNUM<1){
		if (file_exists($SYS_PLUGINS_DIR."gdpr/gdpr.css")){
		...
		if (file_exists($SYS_PLUGINS_DIR."gdpr/gdpr.js")){
